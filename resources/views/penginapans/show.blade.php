 ...
 <script defer>
     ...
     function initialize() {
         var mapOptions = {
             ...
             center: new google.maps.LatLng({{ $penginapan->latitude }}, {{ $penginapan->longitude }}),
         ...
         var marker1 = new google.maps.Marker({
             position : new google.maps.LatLng({{ $penginapan->latitude }}, {{ $penginapan->longitude }}),
             map : map,
             });
